...
class HeaderWidget extends StatefulWidget {
  ...
  const HeaderWidget({super.key,required this.height, required this.showIcon, required this.icon, });
          ...
          child: Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                  colors: [
                    Theme.of(context).colorScheme.onPrimaryFixedVariant.withOpacity(0.4),
            ...
            child: Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(width: 5, color: Theme.of(context).colorScheme.onPrimary),
                ),
                child: Icon(
                  widget.icon,
